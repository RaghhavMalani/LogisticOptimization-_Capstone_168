...
pub fn api_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/live", get(ports::live_national))
        .route("/api/ports", get(ports::list))
        .route("/api/ports/map", get(ports::map))
        .route("/api/ports/:port_id", get(ports::detail))
        .route("/api/ports/:port_id/live", get(ports::live))
        .route("/api/ports/:port_id/wx", get(ports::wx))
        .route("/api/ports/:port_id/sar", get(ports::sar))
        ...
        .route("/api/news", get(ports::news_national))
        .route("/api/ports/:port_id/news", get(ports::news_port))
        .route("/api/ask", post(ports::ask))
